...
public class CharSelection {
	...
	public static CharSelection[] selections1v1 => [
		new CharSelection("X(X1)", 0, 1, 0, "menu_mmx_1", 1),
		new CharSelection("X(X2)", 0, 2, 0, "menu_mmx_2", 2),
		new CharSelection("X(X3)", 0, 3, 0, "menu_mmx_3", 3),
		new CharSelection("X(X4-Stock)", 0, 4, 0, "menu_mmx_4", 4),
		new CharSelection("X(X4-Plasma)", 0, 5, 0, "menu_mmx_5", 5),
		new CharSelection("Zero", 1, 1, 0, "menu_szero", 0),
		new CharSelection("Vile", 2, 1, 0, "menu_vvile", 0),
		new CharSelection("Axl", 3, 1, 0, "menu_aaxl", 0),
		new CharSelection("Sigma", 4, 1, 0, "menu_ssigma", sigmaIndex),
		new CharSelection("Kaiser Zero", 5, 1, 0, "menu_kzero", 5),
		new CharSelection("Buster Zero", 6, 1, 0, "menu_bzero", 0) {
			offset = new Point(2, 45)
		},
		new CharSelection("C.Penguin", 210, 1, 0, "chillp_idle", 0) { offset = new Point(0,0) },
		new CharSelection("S.Mandrill", 212, 1, 1, "sparkm_idle", 0) { offset = new Point(0,0) },
		new CharSelection("A.Armadillo", 213, 1, 2, "armoreda_idle", 0) { offset = new Point(0,0) },
		new CharSelection("L.Octopus", 214, 1, 3, "launcho_idle", 0) { offset = new Point(0,0) },
		new CharSelection("B.Kuwanger", 215, 1, 4, "boomerk_idle", 0) { offset = new Point(0,0) },
		new CharSelection("S.Chameleon", 216, 1, 5, "stingc_idle", 0) { offset = new Point(0,0) },
		new CharSelection("S.Eagle", 217, 1, 6, "storme_idle", 0) { offset = new Point(0,0) },
		new CharSelection("F.Mammoth", 218, 1, 7, "flamem_idle", 0) { offset = new Point(0,0) },
		new CharSelection("Velguarder", 219, 1, 8, "velg_idle", 0) { offset = new Point(0,0) },
		new CharSelection("W.Sponge", 220, 1, 9, "wsponge_idle", 0) { offset = new Point(0,0) },
		new CharSelection("W.Gator", 221, 1, 10, "wheelg_idle", 0) { offset = new Point(0,0) },
		new CharSelection("B.Crab", 222, 1, 11, "bcrab_idle", 0) { offset = new Point(0,0) },
		new CharSelection("F.Stag", 223, 1, 12, "fstag_idle", 0) { offset = new Point(0,0) },
		new CharSelection("M.Moth", 224, 1, 13, "morphm_idle", 0) { offset = new Point(0,0) },
		new CharSelection("M.Centipede", 225, 1, 14, "magnac_idle", 0) { offset = new Point(0,0) },
		new CharSelection("C.Snail", 226, 1, 15, "csnail_idle", 0) { offset = new Point(0,0) },
		new CharSelection("O.Ostrich", 227, 1, 16, "overdriveo_idle", 0) { offset = new Point(0,0) },
		new CharSelection("Fake Zero", 228, 1, 17, "fakezero_idle", 0) { offset = new Point(0,0) },
		new CharSelection("B.Buffalo", 229, 1, 18, "bbuffalo_idle", 0) { offset = new Point(0,0) },
		new CharSelection("T.Seahorse", 230, 1, 19, "tseahorse_idle", 0) { offset = new Point(0,0) },
		new CharSelection("T.Rhino", 231, 1, 20, "tunnelr_idle", 0) { offset = new Point(0,0) },
		new CharSelection("V.Catfish", 232, 1, 21, "voltc_idle", 0) { offset = new Point(0,0) },
		new CharSelection("C.Crawfish", 233, 1, 22, "crushc_idle", 0) { offset = new Point(0,0) },
		new CharSelection("N.Tiger", 234, 1, 23, "neont_idle", 0) { offset = new Point(0,0) },
		new CharSelection("G.Beetle", 235, 1, 24, "gbeetle_idle", 0) { offset = new Point(0,0) },
		new CharSelection("B.Hornet", 236, 1, 25, "bhornet_idle", 0) { offset = new Point(0,0) },
		new CharSelection("Dr.Doppler", 237, 1, 26, "drdoppler_idle", 0) { offset = new Point(0,0) },
	];
