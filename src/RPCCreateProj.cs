	...
	public override void invoke(params byte[] arguments) {
		...
		switch (projId) {
			...
			case (int)ProjIds.BusterX3Proj1:
				proj = new BusterX3Proj1(new Buster(), pos, xDir, arguments[extraDataIndex], player, netProjByte);
				break;
			case (int)ProjIds.BusterX3Proj2:
				proj = new BusterX3Proj2(new Buster(), pos, xDir, arguments[extraDataIndex], player, netProjByte);
				break;
			case (int)ProjIds.BusterX3Proj3:
				proj = new BusterX3Proj3(new Buster(), pos, xDir, arguments[extraDataIndex], player, netProjByte);
				break;
